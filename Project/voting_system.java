	...
	public static void main(String args[])throws IOException ,FileNotFoundException
	{
		    ...
		    switch(c)
		    {
				case 1:
					try
		            {
						File objfile=new File("D:\\java\\Project\\file1.txt");
			       ...
			       // System.out.println("favorite color is"+color);
			        ...
			        if(x==1)
			        {
					    ...
					    if(t==1)
						{
							File objfile1=new File("D:\\java\\Project\\P1.txt");
					    ...
					    {
							File objfile2=new File("D:\\java\\Project\\P2.txt");
						...
						{
							File objfile3=new File("D:\\java\\Project\\P3.txt");
                    ...
                    else if(x==2)
			        {
				        ...
				        if(t==1)
						{
							File objfile4=new File("D:\\java\\Project\\P4.txt");
					    ...
					    {
						    File objfile5=new File("D:\\java\\Project\\P5.txt");
						...
						{
							File objfile6=new File("D:\\java\\Project\\P6.txt");
					...
					else
					{
				        ...
				        if(t==1)
						{
							File objfile7=new File("D:\\java\\Project\\P7.txt");
					    ...
					    {
						    File objfile8=new File("D:\\java\\Project\\P8.txt");
						...
						{
							File objfile9=new File("D:\\java\\Project\\P9.txt");
			    ...
			    case 2:
					...
					if(password==1599)
					{
						...
						System.out.println("3 for Nellore");
				        int ch=sc.nextInt();
				        File f1=new File("D:\\java\\Project\\P1.txt");
					    File f2=new File("D:\\java\\Project\\P2.txt");
					    File f3=new File("D:\\java\\Project\\P3.txt");
					    File f4=new File("D:\\java\\Project\\P4.txt");
						File f5=new File("D:\\java\\Project\\P5.txt");
						File f6=new File("D:\\java\\Project\\P6.txt");
						File f7=new File("D:\\java\\Project\\P7.txt");
						File f8=new File("D:\\java\\Project\\P8.txt");
						File f9=new File("D:\\java\\Project\\P9.txt");
				        if(ch==1)
						{
